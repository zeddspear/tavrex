...
`.agent-logs/2026-09-25_00-03-18_01a09be9-ebf3-79c2-9aa5-7d7a53375762.md`.

The current build prompt is also automatically recorded in a separate session:

`.agent-logs/2026-09-25_00-08-17_01a09bee-62af-7602-bb20-0320c75b9f77.md`.
...
hooks. During the pre-build audit on 2026-09-24, that IDE conversation's latest build
...
* `.agent-logs/2026-09-24_23-44-12_01a09bdc-911e-7692-b52d-4f1c47b3355a.md`

* `.agent-logs/2026-09-24_23-51-36_01a09bdd-b55b-7473-b342-6ab2bdbd8cab.md`
...
2. The first live canary prompt reached the prompt hook, but Codex CLI `0.142.2` could
   ...
   `.agent-logs/2026-09-24_23-38-47_01a09bda-0eef-70c1-ba7a-352a4329a397.md`.
